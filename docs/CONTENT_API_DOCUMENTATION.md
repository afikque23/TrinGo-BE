...
| type       | VARCHAR(255)        | Tipe konten: terms, privacy, guide, about, faq, system_info, support |
...
```
GET /api/v1/motorcycle/admin/contents
```
...
```
POST /api/v1/motorcycle/admin/contents
```
...
- `type`: required, in:[terms, privacy, guide, about, faq, system_info, support]
...
```
GET /api/v1/motorcycle/admin/contents/{id}
```
...
```
PUT /api/v1/motorcycle/admin/contents/{id}
```
...
- `type`: sometimes, required, in:[terms, privacy, guide, about, faq, system_info, support]
...
```
DELETE /api/v1/motorcycle/admin/contents/{id}
```
...
#### 6. Get All Published Contents (Grouped by Type)

```
GET /api/v1/motorcycle/public/contents
```
...
#### 7. Get Published Contents by Type

```
GET /api/v1/motorcycle/public/contents/{type}
```

**Parameters:**

- `type`: terms | privacy | guide | about | faq | system_info | support

**Catatan (FAQ):**

- Untuk menghindari duplikasi card FAQ di mobile, gunakan satu konten FAQ dengan `slug = "faq"`.

**Example:**

```
GET /api/v1/motorcycle/public/contents/terms
```
...
| `support`     | Bantuan & Dukungan  | Help center, contact methods, support info  |
...
curl -X GET "http://localhost:8000/api/v1/motorcycle/public/contents/terms"

# Get all published contents (grouped by type)
curl -X GET "http://localhost:8000/api/v1/motorcycle/public/contents"

# Admin: Create new content (requires token)
curl -X POST "http://localhost:8000/api/v1/motorcycle/admin/contents" \
