            ...
            <nav class="flex-1 overflow-y-auto px-3 pt-4">
                <div class="flex flex-col gap-1">
                    ...
                    <a href="{{ route('admin.templates') }}" class="flex items-center gap-3 pl-3 h-10 rounded-[10px] transition-colors {{ request()->routeIs('admin.templates*') ? 'bg-[#6B7C4F] text-white' : 'text-[#99A1AF] hover:bg-[#1E2939]' }}">
                        ...
                        <span class="text-sm" style="font-family: Arial, sans-serif;">Template Perawatan</span>
                    </a>

                    <a href="{{ route('admin.konten.komunitas') }}" class="flex items-center gap-3 pl-3 h-10 rounded-[10px] transition-colors {{ request()->routeIs('admin.konten*') ? 'bg-[#6B7C4F] text-white' : 'text-[#99A1AF] hover:bg-[#1E2939]' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.33" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        <span class="text-sm" style="font-family: Arial, sans-serif;">Konten Komunitas</span>
                    </a>
