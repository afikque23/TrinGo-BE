...
<div x-show="showDeleteModal" 
    ...
    <div @click.stop class="bg-[#111111] border border-[#1E2939] rounded-[14px] w-full max-w-md">
        ...
        <div class="px-6 py-4 border-b border-[#1E2939]">
            <h3 class="text-lg font-bold text-white" style="font-family: Arial, sans-serif;">Hapus Template Notifikasi</h3>
        </div>
        ...
        <div class="p-6">
            <div class="flex gap-4 mb-4">
                ...
                <div>
                    <p class="text-sm text-white mb-2" style="font-family: Arial, sans-serif;">
                        Apakah Anda yakin ingin menghapus template notifikasi <span class="font-bold" x-text="selectedNotification ? selectedNotification.name : ''"></span>?
                    </p>
            ...
            <form x-show="selectedNotification" :action="`{{ url('admin/notifications') }}/${selectedNotification.id}`" method="POST" class="flex items-center justify-end gap-3">
                @csrf
                @method('DELETE')
