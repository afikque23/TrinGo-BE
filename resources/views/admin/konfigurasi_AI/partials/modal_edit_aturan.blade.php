<!-- Modal Edit Aturan -->
<div id="modalEditAturan" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-[#111111] border border-gray-800 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div class="p-6">
            <!-- Header -->
            <h3 class="text-xl font-bold text-white mb-5">Edit Aturan Insight</h3>
            ...
            <form class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" value="Servis Mendesak" class="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#6B7C4F]">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <option value="km_remaining" selected>km_remaining (Sisa KM ke Servis)</option>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select style="-webkit-appearance:none; -moz-appearance:none; appearance:none;" class="w-full px-4 py-3 pr-10 bg-black border border-gray-700 rounded-lg text-white focus:outline-none focus:border-[#6B7C4F]">
                            <option value="<" selected>&lt; Lebih Kecil</option>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" value="500" class="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#6B7C4F]">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <option value="critical" selected>Critical (Urgent)</option>
                            </select>
                            <svg class="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6 8l4 4 4-4" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                ...
                <div class="p-4 bg-[#6B7C4F]/10 border border-[#6B7C4F]/30 rounded-lg space-y-2">
                    ...
                    <p class="text-sm font-mono text-white">IF Sisa KM ke Servis &lt; 500 → tampilkan Insight 'Servis Mendesak'</p>
                </div>

                <!-- Buttons -->
                <div class="flex gap-3 pt-2">
                    <button type="button" onclick="closeModal('modalEditAturan')" class="flex-1 px-6 py-3 bg-[#2A2A2A] hover:bg-[#3A3A3A] text-white rounded-lg font-bold transition-colors">
                        Batal
                    </button>
