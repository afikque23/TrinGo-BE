...
<div class="flex flex-col gap-6" x-data="{ 
    ...
    <div class="flex flex-col gap-4">
        <div class="flex flex-col gap-2">
            <h1 class="text-2xl font-bold text-white" style="font-family: Arial, sans-serif;">Manajemen Filter & Master Data</h1>
        ...
        <!-- Tab Navigation -->
        <div class="flex gap-2 border-b border-[#1E2939]">
    ...
    <!-- Filter Section -->
    <div class="bg-[#111111] border border-[#1E2939] rounded-[14px] p-[17px]">
