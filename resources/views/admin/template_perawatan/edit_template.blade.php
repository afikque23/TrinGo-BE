...
<div class="bg-[#111111] border border-[#1E2939] rounded-[14px] overflow-hidden w-full">
    ...
    <form id="templateForm" action="{{ route('admin.templates.update', 1) }}" method="POST" class="px-6 pt-6 pb-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-5">
            ...
            <div>
                ...
                >Penggantian oli mesin secara berkala untuk menjaga performa optimal kendaraan.</textarea>
            </div>
                ...
                <div id="stepsContainer" class="space-y-2">
                    ...
                    <div class="flex items-center gap-2 step-item">
                        <input 
                            type="text" 
                            name="langkah[]" 
                            value="Panaskan mesin terlebih dahulu"
