...
```
cd existing_repo
git remote add origin https://gitlab.com/afikque23/motorcycle-management-backend.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/afikque23/motorcycle-management-backend/-/settings/integrations)
